package core.abc
{
	...
	[Bindable]
	public class FileResource extends EventDispatcher implements Resource
	{
		...
		public function FileResource(file:File, id:Number, timestamp:Date)
		{
			this._id = id;
